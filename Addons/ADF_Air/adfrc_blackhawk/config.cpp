...
/////////////////////NOT TO BE USED EVER AGAIN ////////////////////
	class ADFRC_blackhawk_PCW: ADFRC_blackhawk_GWOT
	{
		scope = 0;
		scopeCurator = 0;
	};
	class ADFRC_blackhawk_cargo_PCW: ADFRC_blackhawk_cargo_GWOT
	{
		scope = 0;
		scopeCurator = 0;
	};
	class ADFRC_blackhawk_mag58_PCW: ADFRC_blackhawk_MAG58_GWOT
	{
		scope = 0;
		scopeCurator = 0;
	};
	class ADFRC_blackhawk_esss_PCW: ADFRC_blackhawk_esss_GWOT
	{
		scope = 0;
		scopeCurator = 0;
	};
