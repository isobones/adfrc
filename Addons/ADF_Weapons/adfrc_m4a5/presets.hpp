...
class ADFRC_WP_M4A5_KAC_SpecterKF_PEQ: ADFRC_M4A5_KAC_556
{
	...
	class LinkedItems
	{
		...
		{
			slot = PointerSlot;
			item = ADFRC_PEQ15_M4_Top_BLK_IRL;
		};
	};
};
...
class ADFRC_WP_M4A5_KAC_ACOG_RD_PEQ: ADFRC_M4A5_KAC_556
{
	...
	class LinkedItems
	{
		...
		{
			slot = PointerSlot;
			item = ADFRC_PEQ15_M4_Top_FDE_IRL;
		};
	};
};
...
///GL
class ADFRC_WP_M4A5_203_BLK_Aimpoint_PEQ: ADFRC_M4A5_KAC_M203_556
{
	author = "Brucey";
	class LinkedItems
	{
